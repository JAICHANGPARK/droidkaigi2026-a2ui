...
// Upstream's MaterialSliderComponent.kt at androidx-main 7ce8b02 (19 Aug 2026), copied here
// unmodified and renamed only so the snapshot's newer copy can be excluded by file name.
// HEAD's version calls SliderState(trackRange = ...), which no published material3 has — see
// the note in androidx-a2ui/build.gradle.kts. Delete this file when it does.
